...
- Incomplete data-uri support: `umanit_image_srcset` and `<picture>` sources still called Liip Imagine with data-uri paths
- Corrupted HTML markup generated by `umanit_image_picture_lazy_load`
- Can not use `str_starts_with`
